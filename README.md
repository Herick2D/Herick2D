...
## 👨‍💻 Linguagens: 
[![My Skills](https://skillicons.dev/icons?i=java,javascript,typescript,nodejs,c,cpp)](https://skillicons.dev)
...
## ⚙️ Ferramentas:
[![My Skills](https://skillicons.dev/icons?i=linux,maven,npm,git,github,vscode,visualstudio,eclipse,idea,webstorm,postman,docker,arduino)](https://skillicons.dev)<br><br>
